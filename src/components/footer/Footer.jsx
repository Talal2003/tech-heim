          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, py: 2 }}>
            ...
            <Box>
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5, p: 1 }}>
                <Typography component={'h3'} variant="body1">Sign up for News and updates</Typography>
                <Box sx={{
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }}>
              <Accordion disableGutters sx={{
                ...
                <AccordionSummary expandIcon={<ExpandMoreIcon sx={{ color: "white" }} />}
                  ...
                  <Typography component={'h3'} variant="subtitle1">Company</Typography>
                </AccordionSummary>
              ...
              <Accordion disableGutters sx={{
                ...
                <AccordionSummary expandIcon={<ExpandMoreIcon sx={{ color: "white" }} />}
                  slotProps={{ root: { sx: { px: 0, py: 1, minHeight: 0 }, }, content: { sx: { m: 0, }, } }}>
                  <Typography component={'h3'} variant="subtitle1">Info</Typography>
                </AccordionSummary>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, px: 1.5 }}>
                  <Link component={RouterLink} variant="body2" to='/' color='#CBCBCB' underline='none'>How it works?</Link>
                  <Link component={RouterLink} variant="body2" to='/' color='#CBCBCB' underline='none'>our promises</Link>
              ...
              <Accordion disableGutters sx={{
                ...
                <AccordionSummary expandIcon={<ExpandMoreIcon sx={{ color: "white" }} />}
                  slotProps={{ root: { sx: { px: 0, py: 1, minHeight: 0 }, }, content: { sx: { m: 0, }, } }}>
                  <Typography component={'h3'} variant="subtitle1">Contact us</Typography>
                </AccordionSummary>
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1, px: 1.5 }}>
                  <Typography variant="body2" to='/' color='#CBCBCB' underline='none'>123 Main Street, Anytown,USA</Typography>
                  <Typography variant="body2" to='/' color='#CBCBCB' underline='none'>+1 (555) 123-4567</Typography>
